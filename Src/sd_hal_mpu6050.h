 ...
 */
SD_MPU6050_Result SD_MPU6050_Init(I2C_HandleTypeDef* I2Cx,
		SD_MPU6050* DataStruct, SD_MPU6050_Device DeviceNumber,
 ...
 */
SD_MPU6050_Result SD_MPU6050_SetGyroscope(I2C_HandleTypeDef* I2Cx,
		SD_MPU6050* DataStruct, SD_MPU6050_Gyroscope GyroscopeSensitivity);
 ...
 * @retval Member of @ref SD_MPU6050_Result_t enumeration
 */
SD_MPU6050_Result SD_MPU6050_SetAccelerometer(I2C_HandleTypeDef* I2Cx,
		SD_MPU6050* DataStruct,
		SD_MPU6050_Accelerometer AccelerometerSensitivity);
 ...
 * @retval Member of @ref SD_MPU6050_Result_t enumeration
 */
SD_MPU6050_Result SD_MPU6050_SetDataRate(I2C_HandleTypeDef* I2Cx,
		SD_MPU6050* DataStruct, uint8_t rate);
 ...
 * @retval Member of @ref SD_MPU6050_Result_t enumeration
 */
SD_MPU6050_Result SD_MPU6050_EnableInterrupts(I2C_HandleTypeDef* I2Cx,
		SD_MPU6050* DataStruct);
 ...
 * @retval Member of @ref SD_MPU6050_Result_t enumeration
 */
SD_MPU6050_Result SD_MPU6050_DisableInterrupts(I2C_HandleTypeDef* I2Cx,
		SD_MPU6050* DataStruct);
 ...
 * @retval Member of @ref SD_MPU6050_Result_t enumeration
 */
SD_MPU6050_Result SD_MPU6050_ReadInterrupts(I2C_HandleTypeDef* I2Cx,
		SD_MPU6050* DataStruct, SD_MPU6050_Interrupt* InterruptsStruct);
 ...
 */
SD_MPU6050_Result SD_MPU6050_ReadAccelerometer(I2C_HandleTypeDef* I2Cx,
		SD_MPU6050* DataStruct);
 ...
 *            - Other: in other cases
 */
SD_MPU6050_Result SD_MPU6050_ReadGyroscope(I2C_HandleTypeDef* I2Cx,
		SD_MPU6050* DataStruct);
 ...
 *            - Other: in other cases
 */
SD_MPU6050_Result SD_MPU6050_ReadTemperature(I2C_HandleTypeDef* I2Cx,
		SD_MPU6050* DataStruct);
 ...
 *            - Other: in other cases
 */
SD_MPU6050_Result SD_MPU6050_ReadAll(I2C_HandleTypeDef* I2Cx,
		SD_MPU6050* DataStruct);
